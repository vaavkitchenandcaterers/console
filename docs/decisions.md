...
- Build occasion service pages at `/services/<occasion>/`, generated by
  ...
  come from the occasion tags in `menu-data.js`. Phase 1 builds two:
  `wedding-reception-catering` (wedding and reception tags; the largest set per
  meal, since 40 sets would bury the form) and `puja-homam-catering` (puja and
  temple tags; all 7 sets).
